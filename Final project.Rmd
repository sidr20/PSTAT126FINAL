...
We found that taking the log of the response variable and predictors changed the interpretation of the model to talking about proportions instead of dollar amount like the original simple linear regression model.\
